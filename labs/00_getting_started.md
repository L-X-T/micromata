...
In this part of the tutorial, you will pull (or download & extract ``micromata.zip``) the starter kit and run it.

1. Pull the starter kit:

    https://github.com/L-X-T/micromata
...
In this part of the exercise, you will extract the starter kit (``micromata.zip``) and run it.
